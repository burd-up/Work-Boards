...
const initialState: initialStateType = {
    currentUser: {id: 0, name: 'Roman', surname: 'Lukichev', position: 'frontend developer', accesses: [1], projects: [0,2,3]},
    users: [
        ...
        {id: 2, name: 'Andrey', surname: 'Lukichev', position: 'team leader', accesses: [1,2,3], projects: [0,3]}, //accessLevel: 3 означает что есть доступ к созданию задач
